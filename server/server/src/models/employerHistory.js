...
const employerHistorySchema = new mongoose.Schema({
...
const EmployerHistory = mongoose.model('EmployerHistory', employerHistorySchema);

module.exports = EmployerHistory;